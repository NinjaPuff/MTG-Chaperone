...
function configureApi(eventStatus: 'setup' | 'active' | 'completed', rounds: Array<{ id: string; roundNumber: number; status: 'not_started' | 'in_progress' | 'completed'; matches: unknown[] }>) {
  const eventData = {
    id: 'e1',
    name: 'Week 1',
    status: eventStatus,
