    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div className="rounded-lg border border-border bg-card p-6">
          ...
          <p className="text-muted-foreground text-sm">Sign in to view your season record.</p>
        </div>
        <div className="rounded-lg border border-border bg-card p-6">
          <h3 className="text-lg font-semibold mb-4">Career Stats</h3>
          <p className="text-muted-foreground text-sm">Sign in to view your career history.</p>
        </div>
      </div>
    </div>
  );
